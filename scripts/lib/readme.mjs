...
function statsUrls(username) {
  return {
    // Self-hosted, generated by .github/workflows/metrics.yml and committed to the repo as metrics.svg.
    // This avoids the public github-readme-stats.vercel.app instance, which is frequently rate-limited or down.
    metrics: "./metrics.svg",
...
<p align="center">
  <img src="${stats.metrics}" alt="GitHub metrics" width="100%">
</p>
